...
typedef struct
{
	...
	uint8_t GPIO_PinPuPdControl; /* Pin pull-up pull-down resistor controller */
	uint8_t GPIO_PinOPType;
	uint8_t GPIO_PinAltFunMode; /* Pin alternate function controller */
...
#define GPIO_MODE_IT_RFT 6 /* Interrupt mode for rising-falling edge */
...
/*
 * GPIO pin pull-up pull-down res configurations
 */
